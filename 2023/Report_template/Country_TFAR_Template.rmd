...
# Preliminaries that need to be set
  ...
  tmp <- read.csv(paste0("./Figures/", cnt_sht, "/catch_summary_table.csv"))
...
\begin{figure}[!ht]
 \includegraphics [width=11cm]{./Figures/Regional/Fig23b-shark.kobe.crosshairs.png} \\
 \includegraphics [width=11cm]{./Figures/Regional/Fig23a-billfish.kobe.crosshairs.png}
...
\begin{figure}[!ht]
 ...
 \includegraphics [width=17cm]{\cntpth regional_depletion_skj.png}
  \caption [Depletion history for skipjack at region level]{Depletion of skipjack at region scale. \label{tmp3}}
\end{figure}
...
\begin{figure}[!ht]
 ...
 \includegraphics [width=17cm]{\cntpth regional_depletion_yft.png}
  \caption [Depletion history for yellowfin at region level]{Depletion of yellowfin at region scale. \label{tmp4}}
\end{figure}
