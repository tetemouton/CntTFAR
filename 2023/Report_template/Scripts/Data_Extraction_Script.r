...
write.csv(dat, file = paste0(dat_pth, "Ann_All-Gear_Cat_Effort_Flg_5x5_AllOceans.csv"), row.names = FALSE)
...
write.csv(dat_ez, file = paste0(dat.pth, "Ann_Cat_EEZ_ACE.csv"), row.names = FALSE)
